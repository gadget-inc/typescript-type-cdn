...
const App = () => {
  ...
  return (
    <main>
      ...
      <p>This Gadget application serves condensed TypeScript types for packages from NPM.</p>
      <h2>API</h2>
      <p>
        <ul>
          <li>
            <code>GET /types/package/&lt;package&gt;@&lt;version&gt;</code> - Get all the types for a given <code>package</code> at a given{" "}
            <code>version</code>
            <br />
          ...
          <li>
            ...
            list of <code>packages</code> at a given <code>versions</code>
            <br />
            <Example href="/types/group?packages=got@11.0.0,lodash@4.0.0" />
          </li>
        </ul>
      </p>
    </main>
